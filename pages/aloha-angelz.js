...
import styles from "../assets/jss/nextjs-material-kit/pages/herproductsPage";
...
export default function herProductsPage(props) {
                ...
                <div className={classes.container}>
                    <GridContainer>
                        <GridItem xs={12} sm={12} md={6}>
                            <h1 className={classes.title}>Bikini Selection Coming Soon ...</h1>
                            <h4>
